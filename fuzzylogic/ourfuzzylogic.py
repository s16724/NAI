...
'''
Określenie danych wejściowych i wyjściowych wygląda wygląda następująco:
...
#definiujemy membership funcions zaczynając od danyczah wejściowych i kończątc na wyjściowych
